...
class Colorpicker {
    ...
    static get style() { return ":host{display:inline-block;position:relative;-webkit-box-sizing:border-box;box-sizing:border-box;width:var(--element-size,32px);height:var(--element-size,32px);border-radius:50%;padding:2px;background:#fff;-webkit-box-shadow:0 0 6px 0 rgba(0,0,0,.1);box-shadow:0 0 6px 0 rgba(0,0,0,.1);vertical-align:middle}:host .color{display:block;width:calc(var(--element-size, 32px) - 4px);height:calc(var(--element-size, 32px) - 4px);border-radius:50%;background:#fafbfd;cursor:pointer}:host .selector{position:absolute;visibility:hidden;opacity:0;-webkit-transform:scale(0);transform:scale(0);margin:auto;top:0;bottom:0;cursor:crosshair;-webkit-transition:all .2s ease-in-out;transition:all .2s ease-in-out;z-index:var(--element-zindex,9999)}:host .selector.opened{visibility:visible;opacity:1;-webkit-transform:scale(1);transform:scale(1)}:host(:focus){outline:none}"; }
}
